...
public class Main {
    public static void main(String[] args) {
        ...
        list.add(new Baju("B001", "Kaos_Polos", 120000, 50, "Pakaian", "Katun", "Hitam", "Unisex", "L", "Nike"));
        list.add(new Baju("B002", "Jaket_Hoodie", 250000, 30, "Pakaian", "Fleece", "Abu-abu", "Pria", "XL", "Adidas"));
        list.add(new Baju("B003", "Kemeja_Formal", 300000, 20, "Pakaian", "Linen", "Putih", "Pria", "M", "Zara"));
        list.add(new Baju("B004", "Blouse_Casual", 180000, 40, "Pakaian", "Sifon", "Merah", "Wanita", "S", "H&M"));
