...
def tampilkan_header(panjang):
    ...
    print("| " + " | ".join(f"{header[i]:<{panjang[i]}}" for i in range(10)) + " |")

# fungsi buat nampilin garis pemisah di tabel
def tampilkan_pembatas(panjang):
    print("+" + "+".join("-" * (panjang[i] + 2) for i in range(10)) + "+")

# fungsi buat nampilin data baju dalam format tabel
def tampilkan_data(list_baju, panjang):
    for b in list_baju:
        print(f"| {b.get_id():<{panjang[0]}} | {b.get_nama():<{panjang[1]}} | {b.get_harga():<{panjang[2]}} | "
              f"{b.get_stok():<{panjang[3]}} | {b.get_jenis():<{panjang[4]}} | {b.get_bahan():<{panjang[5]}} | "
              f"{b.get_warna():<{panjang[6]}} | {b.get_untuk():<{panjang[7]}} | {b.get_size():<{panjang[8]}} | "
              f"{b.get_merk():<{panjang[9]}} |")
