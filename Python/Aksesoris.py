...
class Aksesoris(PetShop):
    ...
    # buat nampilin data aksesoris
    def display(self):
        # panggil display dari petshop biar data umum tetep ditampilin
        super().display()
        # tambahin data spesifik aksesoris
        print(f" | jenis: {self.__jenis} | bahan: {self.__bahan} | warna: {self.__warna}")
